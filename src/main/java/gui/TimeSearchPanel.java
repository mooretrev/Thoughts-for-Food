...
public class TimeSearchPanel extends JPanel {
    ...
    TimeSearchPanel(Data data) {
    	this.data = data;
        titleLabel = new JLabel("Time Search");
        instrLabel = new JLabel("Search for recipies by time below:");
    ...
    private class searchBtnListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent s) {
            ...
            TimeSearch search = new TimeSearch(data);
